...
/**
 * Tests unitaires pour la classe MergeSort. Hérite de la classe SetUpTests pour récupérer des arrays à tester.
 */
@DisplayName("test de la classe MergeSort")
class MergeSortTest extends SetUpTests {
	
	@Test
	@DisplayName("test du tri sur un tableau vide")
	void testTrierTableauVide() {
		MergeSort.sort(tableauVide);
	...
	void testTrierTableauUnElement() {
		MergeSort.sort(tableauUnElement);
	...
	void testTrierTableauAleatoire() {
		MergeSort.sort(tableauAleatoire);
	...
	void testTrierTableauDoublons() {
		MergeSort.sort(tableauDoublons);
