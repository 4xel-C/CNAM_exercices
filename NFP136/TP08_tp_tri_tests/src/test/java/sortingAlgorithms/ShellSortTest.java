...
/**
 * Tests unitaires pour la classe ShellSort. Hérite de la classe SetUpTests pour récupérer des arrays à tester.
 */
@DisplayName("test de la classe ShellSort")
class ShellSortTest extends SetUpTests {
	
	@Test
	@DisplayName("test du tri sur un tableau vide")
	void testTrierTableauVide() {
		ShellSort.sort(tableauVide);
	...
	void testTrierTableauUnElement() {
		ShellSort.sort(tableauUnElement);
	...
	void testTrierTableauAleatoire() {
		ShellSort.sort(tableauAleatoire);
	...
	void testTrierTableauDoublons() {
		ShellSort.sort(tableauDoublons);
