...
/**
 * Tests unitaires pour la classe QuickSort. Hérite de la classe SetUpTests pour récupérer des arrays à tester.
 */
@DisplayName("test de la classe QuickSort")
class QuickSortTest extends SetUpTests {
	
	@Test
	@DisplayName("test du tri sur un tableau vide")
	void testTrierTableauVide() {
		QuickSort.sort(tableauVide);
	...
	void testTrierTableauUnElement() {
		QuickSort.sort(tableauUnElement);
	...
	void testTrierTableauAleatoire() {
		QuickSort.sort(tableauAleatoire);
	...
	void testTrierTableauDoublons() {
		QuickSort.sort(tableauDoublons);
